...
namespace Senparc.Weixin.QY.Test.CommonApis
{
    ...
    {
        protected string _corpId = "wx8c5031060facd904"; //换成你的信息
        protected string _corpSecret = "ImiGfOnVhjA5dLYkdS9zcNH_CX4bFX5skBw2v0HjbidFDakXg5F6V9HqAnSUK3s7"; //换成你的信息
